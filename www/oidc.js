...
/**
 * A request returned w/ an authorization response. Contains info provided by calling code in its
 * authorization request plus additional request params generated by the plugin (e.g. state, nonce,
 * PKCE params)
 */
